package POO.exercicios.fixacao.exercicioFile.application;
...
import POO.exercicios.fixacao.exercicioFile.entities.Product;
...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        String strTargetFile = sourceFolder + "\\out\\summary.csv";
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(strFile))) {
            ...
            try (BufferedWriter bw = new BufferedWriter(new FileWriter(strTargetFile))) {
                ...
                System.out.println(strTargetFile + " CREATED!");
            } catch (IOException e) {
